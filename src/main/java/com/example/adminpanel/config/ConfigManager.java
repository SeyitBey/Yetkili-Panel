...
public class ConfigManager {
    ...
    public void loadConfigurations() {
        load("config.yml"); load("messages.yml"); load("gui.yml");
        load("staff.yml"); load("database.yml"); load("discord.yml");
    }
    ...
    public FileConfiguration getStaff() { return configs.get("staff.yml"); }
}
